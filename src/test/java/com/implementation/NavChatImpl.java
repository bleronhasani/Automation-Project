...
//    private final By searchBar = By.cssSelector("input[placeholder='Search']");
    ...
    private final By selectAllBtn3 = By.xpath("//*[@id=\"root\"]/div/div[2]/div[2]/div/div[2]/div/div[3]/div[5]/div/div[3]");
    ...
    private final By dmMessage = By.xpath("//*[@id=\"root\"]/div/div[2]/div[1]/div[2]/a[1]/div/div[2]");
...
//    private final By directMSG = By.xpath("//span[contains(text(),'ShedwoolAutomation')]");
    ...
    public NavChatImpl(WebDriver chrome) {
        this.chrome = chrome;
    }

    // ========== METHODS ==========
    public NavChatImpl sideBarChatBtn() throws InterruptedException {
        Thread.sleep(1000);
    ...
    public NavChatImpl newGroup(String searchBarinput)throws InterruptedException{
...
//        chrome.findElement(backBtn).click();
        ...
        chrome.findElement(selectAllBtnForChat).click();
        Thread.sleep(3000);
        chrome.findElement(createGroup).click();
        return this;
    }
    public NavChatImpl newChanel(String chanelName,String descriptionTextArea,String searchBarinput,String directMessageinput)throws InterruptedException{
        chrome.navigate().to("https://test.shedwool.com/message/new");
//        chrome.findElement(newChatbtn).click();
        Thread.sleep(1000);
