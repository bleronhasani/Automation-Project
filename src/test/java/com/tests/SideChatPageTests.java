...
import com.implementation.SideChatPageImpl;
import org.testng.annotations.Test;

public class SideChatPageTests extends OpenBrowser {
    ...
    LoginImpl login;
    SideChatPageImpl sideChatPageImpl;
    ...
    public void testMethod() throws InterruptedException {
        ...
        sideChatPageImpl = new SideChatPageImpl(chrome);

        login.loginUser(email, password);
        sideChatPageImpl.sideBarChatBtn();
        sideChatPageImpl.newGroup(chanelName,descriptionTextArea);
        sideChatPageImpl.newChanel(chanelName,descriptionTextArea,searchBarinput,directMessageinput);
